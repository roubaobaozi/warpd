...
static struct {
	...
	{ "decelerator", "r", "Decrease the speed of the pointer while held.", OPT_KEY },
	{ "buttons", "l j ;",  "A space separated list of mouse buttons (2 is middle click).", OPT_BUTTON },
	{ "oneshot_buttons", "L J :", "Oneshot mouse buttons (deactivate on click).", OPT_BUTTON },

	{ "print", "p", "Print the current mouse coordinates to stdout (useful for scripts).", OPT_KEY },
	{ "history", "h", "Activate hint history mode while in normal mode.", OPT_KEY },
	...
	{ "down", "i", "Move the cursor down in normal mode.", OPT_KEY },
	{ "up", "e", "Move the cursor up in normal mode.", OPT_KEY },
	{ "right", "o", "Move the cursor right in normal mode.", OPT_KEY },
	{ "top", "E", "Moves the cursor to the top of the screen in normal mode.", OPT_KEY },
	{ "middle", "H", "Moves the cursor to the middle of the screen in normal mode.", OPT_KEY },
	{ "bottom", "I", "Moves the cursor to the bottom of the screen in normal mode.", OPT_KEY },
	{ "start", "N", "Moves the cursor to the leftmost corner of the screen in normal mode.", OPT_KEY },
	{ "end", "O", "Moves the cursor to the rightmost corner of the screen in normal mode.", OPT_KEY },

	{ "scroll_down", "y", "Scroll down key.", OPT_KEY },
	{ "scroll_up", "u", "Scroll up key.", OPT_KEY },
	...
	{ "grid_up", "e", "Move the grid up.", OPT_KEY },
	{ "grid_left", "n", "Move the grid left.", OPT_KEY },
	{ "grid_down", "i", "Move the grid down.", OPT_KEY },
	{ "grid_right", "o", "Move the grid right.", OPT_KEY },
	{ "grid_keys", "m , . /", "A sequence of comma delimited keybindings which are ordered bookwise with respect to grid position.", OPT_KEY },
	...
	{ "hint2_chars", "ntesiroamvclpufywhdx", "The character set used for the second hint selection, should consist of at least hint_grid_size^2 characters.", OPT_STRING },
